...
class Humen {
  constructor(options) {
    ...
    this.age = {
      value: new Date().getFullYear() - this.bornIn,
      writable: false, // writable  - я заприщаю запись в данное поле
      configurable: false, // configurable - запрещаю удалять это поле
    }
  }
  voice() {
    console.log('Heloo im ')
  }
}
